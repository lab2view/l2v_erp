<template>
  <div>
    <!-- Loader starts-->
    <div v-show="false" class="loader-wrapper">
              ...
              <li>
                <form class="form-inline search-form">
                  <div class="search-bg"><i class="fa fa-search"></i>
                    <input class="form-control-plaintext" placeholder="Search heretemplatetemplate.">
                  </div>
                ...
                <div class="bookmark-dropdown onhover-show-div">
                  <div class="form-group mb-0">
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" placeholder="Search for bookmarktemplate.">
                    </div>
                  </div>
                  <ul class="m-t-5">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="template/assets/images/user/4.jpg" alt="">
                      <div class="media-body"><span>Ain Chavez</span>
                        <p class="f-12 light-font">Lorem Ipsum is simply dummytemplate.</p>
                      </div>
            ...
            <div class="main-navbar">
              <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="template/theme/index.html" target="_blank"><i data-feather="home"></i><span>Dashboard</span></a></li>
            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Layout Light</h3>
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="template/ltr/index.html">Home</a></li>
