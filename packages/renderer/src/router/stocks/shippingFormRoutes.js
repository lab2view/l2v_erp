...
export default [
  ...
  },
  {
    ...
    component: () => import('/@/views/stocks/shipping/form/ProvisionLinesForm.vue'),
    meta: {
      ...
      return store
        ...
        .then((shipping) => {
          if(to.query.stock_entry_id)
            return store.dispatch('stock_entry/getStockEntry').then(()=> 1).catch(()=> -1);
          else
            return shipping.stock_provisions.length ? 1:-1;
        })
        .catch(() => -1);
    },
  },
