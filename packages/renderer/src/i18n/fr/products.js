export default {
  ...
  form: {
    ...
    setting: {
      ...
      property: 'Gerer les caracteristiques',
    },
  },
  package: {
    listTitle: 'Liste des conditionnements',
    formCreateTitle: 'Ajouter un conditionnement',
    formUpdateTitle: 'Modifier un conditionnement',
    store:
      "L'enregistrement du type de conditionnement a ete effectue avec succes",
    update:
      'La modification du type de conditionnement a ete effectuee avec succes',
  },
  property: {
  ...
  productFamily: {
    ...
    store:
      "L'enregistrement de la famille de produit a ete effectue avec succes",
    update:
