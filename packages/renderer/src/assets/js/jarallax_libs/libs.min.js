!(function (t, e) {
  ...
  var E = (function (t) {
    ...
    return (
      ...
      lt(function (t) {
        return (
          (t.innerHTML = "<a href='javascript:void(0)'></a>"),
  ...
  (function (t, e) {
      ...
      E = (function () {
        ...
        return (
          (e.toggle = function () {
            var t = !0,
              e = !0,
              i = n(this._element).closest('[data-bs-toggle="buttons"]')[0];
            if (i) {
    ...
    n(document).on(bt.CLICK_DATA_API, '[data-bs-toggle="modal"]', function (t) {
      var e,
        i = this,
