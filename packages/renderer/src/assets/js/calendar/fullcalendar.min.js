...
(function (t) {
  ...
  function me(n, r) {
    ...
    function a() {
      (se = J.theme ? 'ui' : 'fc'),
        n.addClass('fc'),
        J.isRTL ? n.addClass('fc-rtl') : n.addClass('fc-ltr'),
        J.theme ? n.addClass('ui-widget') : n.addClass('fc-unthemed'),
        (re = t("<div class='fc-view-container'/>").prependTo(n)),
        (ne = new ve(K, J)),
        (ie = ne.render()),
        ie && n.prepend(ie),
        c(J.defaultView),
        J.handleWindowResize &&
          ((ae = G(w, J.windowResizeDelay)), t(window).resize(ae));
    }
    function u() {
      oe && oe.destroyView(),
        ne.destroy(),
    ...
    function c(e) {
      ge++,
        oe &&
          e &&
          oe.type !== e &&
          (ne.deactivateButton(oe.type),
          W(),
          oe.start && oe.destroyView(),
          oe.el.remove(),
          (oe = null)),
        !oe &&
          e &&
          ((oe = h(e)),
          (oe.el = t("<div class='fc-view fc-" + e + "-view' />").appendTo(re)),
          ne.activateButton(e)),
        oe &&
          ((ue = oe.massageCurrentDate(ue)),
          (oe.start && ue.isWithin(oe.intervalStart, oe.intervalEnd)) ||
            (d() &&
              (W(),
              oe.start && oe.destroyView(),
              oe.setDate(ue),
        ...
        s
          ? ((l = r.duration || s.duration),
            ...
            (u =
              ...
              (l ? o(l) : null) ||
              n),
            (fe[n] = { class: s, options: r, buttonText: u }))
          : void 0
      );
    }
    function g(t) {
    ...
    function y() {
      le =
        'number' == typeof J.contentHeight
          ? J.contentHeight
          : 'number' == typeof J.height
          ? J.height - (ie ? ie.outerHeight(!0) : 0)
          : Math.round(re.width() / Math.max(J.aspectRatio, 0.5));
    }
    function w(t) {
      !ge &&
        t.target === window &&
    ...
    function F() {
      var t = K.getNow();
      t.isWithin(oe.intervalStart, oe.intervalEnd)
    ...
    function z(t, e) {
      (t = K.moment(t)),
        (e = e
          ? K.moment(e)
          : t.hasTime()
          ? t.clone().add(K.defaultTimedEventDuration)
          : t.clone().add(K.defaultAllDayEventDuration)),
        oe.select({ start: t, end: e });
    }
    function L() {
      oe && oe.unselect();
    }
    ...
    function q(t, e) {
      return J[t]
        ? J[t].apply(e || he, Array.prototype.slice.call(arguments, 2))
        : void 0;
    }
    var K = this;
    r = r || {};
    var Q,
      J = i({}, Ee, r);
    (Q = J.lang in Te ? Te[J.lang] : Te[Ee.lang]),
      Q && (J = i({}, Ee, Q, r)),
      J.isRTL && (J = i({}, Ee, be, Q || {}, r)),
      (K.options = J),
      (K.render = l),
      (K.destroy = u),
      (K.refetchEvents = E),
      (K.reportEvents = R),
      (K.reportEventChange = k),
      (K.rerenderEvents = S),
      (K.changeView = c),
      (K.select = z),
      (K.unselect = L),
      ...
      (K.trigger = q),
      (K.isValidViewType = g),
      (K.getViewButtonText = p);
    var te = x(s(J.lang));
    if (
      (J.monthNames && (te._months = J.monthNames),
      J.monthNamesShort && (te._monthsShort = J.monthNamesShort),
      J.dayNames && (te._weekdays = J.dayNames),
      J.dayNamesShort && (te._weekdaysShort = J.dayNamesShort),
      null != J.firstDay)
    ) {
      var ee = x(te._week);
      (ee.dow = J.firstDay), (te._week = ee);
    }
    (K.defaultAllDayEventDuration = e.duration(J.defaultAllDayEventDuration)),
      (K.defaultTimedEventDuration = e.duration(J.defaultTimedEventDuration)),
      (K.moment = function () {
        var t;
        return (
          'local' === J.timezone
          ...
          '_locale' in t ? (t._locale = te) : (t._lang = te),
          t
        );
      }),
      ...
      (K.getDefaultEventEnd = function (t, e) {
        ...
        return (
          t
            ? n.stripTime().add(K.defaultAllDayEventDuration)
            : n.add(K.defaultTimedEventDuration),
          K.getIsAmbigTimezone() && n.stripZone(),
          n
        );
      }),
      ye.call(K, J);
    var ne,
      ...
      ge = 0,
      pe = [];
    (ue = null != J.defaultDate ? K.moment(J.defaultDate) : K.getNow()),
