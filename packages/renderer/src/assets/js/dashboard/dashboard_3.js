// history
var lineArea1 = new Chartist.Line(
  '.history',
  {
    labels: ['1', '2', '3', '4', '5'],
    series: [
  ...
  if ('point' === e.type) {
    var t = new Chartist.Svg('circle', {
      ...
      r: 5,
      class:
        5 === e.value.y ? 'ct-point circle-point' : 'ct-point circle-trans',
    });
    e.element.replace(t);
  }
});
...
var chart1 = new ApexCharts(document.querySelector('#websites'), options1);
