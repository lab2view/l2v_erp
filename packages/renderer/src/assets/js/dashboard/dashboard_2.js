...
var chart51 = new ApexCharts(
  document.querySelector('#chart-yearly-growth-dash-2'),
  options51
);
chart51.render();
...
Chart.types.Bar.extend({
  ...
  initialize: function (data) {
    ...
    if (this.options.curvature !== undefined && this.options.curvature <= 1) {
      ...
      var self = this;
      var radius =
        this.datasets[0].bars[0].width * this.options.curvature * 0.2;
  ...
  datasets: [
    {
      ...
      strokeColor: '#1faf4b',
      data: [
        400, 230, 448, 370, 540, 580, 690, 1100, 1200, 1380, 1150, 580, 330,
        580, 1355, 1280, 1485, 875, 356, 587, 954, 325, 469, 1254, 1587, 543,
        370, 987, 675, 345, 895, 1200, 1265, 987, 1400, 852, 654, 254, 155, 899,
        754, 254, 789, 235, 456, 256, 900,
      ],
    },
  ],
};
  ...
  series: [
    {
      name: 'Inflation',
      data: [
        2.3, 5.1, 3.0, 9.1, 2.0, 4.6, 2.2, 9.3, 5.4, 4.8, 3.5, 5.2, 2.3, 5.1,
        3.0, 9.1, 2.0, 4.6, 2.2, 9.3, 5.4, 4.8, 3.5, 5.2,
      ],
