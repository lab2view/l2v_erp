...
!(function () {
  ...
  function s(s, n) {
    ...
    if (
    ...
    ) {
      {
        var x = [
          ...
          '<button type="button" class="btn btn-default clockpicker-button clockpicker-am-button">',
          'AM</button>',
    ...
    n.autoclose ||
      c(
        '<button type="button" class="btn btn-sm btn-default btn-block clockpicker-button btn-primary">' +
          n.donetext +
          '</button>'
      )
  ...
  var o,
    ...
    A = [
      ...
      '<span class="clockpicker-span-hours txt-primary"></span>',
      ' : ',
  ...
  (s.DEFAULTS = {
    ...
    (s.prototype.toggleView = function (t, i) {
      ...
      (this.currentView = t),
        this.spanHours.toggleClass('txt-primary', e),
        this.spanMinutes.toggleClass('txt-primary', !e),
