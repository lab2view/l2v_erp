...
(function (W) {
  ...
  var M = s.toString,
    ...
    ga =
      v && navigator.platform === 'PLAYSTATION 3'
        ? /^complete$/
        : /^(complete|loaded)$/,
  ...
  if (typeof define === 'undefined') {
    ...
    s = g.s = {
      ...
      newContext: function (b) {
        ...
        function d(a) {
          v &&
            t(document.getElementsByTagName('script'), function (f) {
              if (
                f.getAttribute('data-requiremodule') === a &&
                f.getAttribute('data-requirecontext') === h.contextName
              )
        ...
        function i(a) {
          var f,
            b = a ? a.indexOf('!') : -1;
          b > -1 &&
            ((f = a.substring(0, b)), (a = a.substring(b + 1, a.length)));
          return [f, a];
        }
        function j(a, f, b, e) {
          var m,
        ...
        function w() {
          var a,
            ...
            m =
              (b = k.waitSeconds * 1e3) &&
              h.startTime + b < new Date().getTime(),
            c = [],
            g = [],
            i = !1,
            j = !0;
          if (!S) {
            ...
            if (m && c.length)
              return (
                (b = G('timeout', 'Load timeout for modules: ' + c, null, c)),
                (b.contextName = h.contextName),
                z(b)
              );
            j &&
              t(g, function (a) {
              ...
              r(this, function (e) {
                ...
                if (this.map.unnormalized) {
                  if (
                    ...
                    (e = j(a.prefix + '!' + d, this.map.parentMap)),
                    q(
                      e,
                      'defined',
                      r(this, function (a) {
        ...
        h = {
            ...
            O(d, {
              ...
              toUrl: function (b) {
                var d = b.lastIndexOf('.'),
                  f = null;
                d !== -1 &&
                  ((f = b.substring(d, b.length)), (b = b.substring(0, d)));
          ...
          onScriptLoad: function (a) {
            if (
              a.type === 'load' ||
              ga.test((a.currentTarget || a.srcElement).readyState)
            )
    ...
    if (
      v &&
      ((u = s.head = document.getElementsByTagName('head')[0]),
    ...
    g.load = function (b, c, d) {
      ...
      if (v)
        return (
          ...
          (i.type = g.scriptType || 'text/javascript'),
          (i.charset = 'utf-8'),
          (i.async = !0),
          i.setAttribute('data-requirecontext', b.contextName),
          i.setAttribute('data-requiremodule', c),
          i.attachEvent &&
          !(
          ...
          !R
            ...
            : (i.addEventListener('load', b.onScriptLoad, !1),
              i.addEventListener('error', b.onScriptError, !1)),
          (i.src = d),
          (I = i),
    ...
    define = function (b, c, d) {
      ...
      !c.length &&
        ...
        (d
          .toString()
          .replace(ca, '')
          .replace(da, function (b, d) {
            c.push(d);
          }),
        (c = (
          d.length === 1 ? ['require'] : ['require', 'exports', 'module']
        ).concat(c)));
      if (J && (g = I || ba()))
        b || (b = g.getAttribute('data-requiremodule')),
          (i = w[g.getAttribute('data-requirecontext')]);
