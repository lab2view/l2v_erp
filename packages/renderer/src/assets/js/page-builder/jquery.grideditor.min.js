!(function (a) {
  (a.fn.gridEditor = function (b) {
    ...
    return (
      c.each(function (c, d) {
        function e() {
          (A = d.addClass('ge-canvas')),
            ('undefined' != typeof D && D.length) ||
              (D = a('<textarea class="ge-html-output"/>').insertBefore(A)),
            (B = a('<div class="ge-mainControls" />').insertBefore(D));
          var b = a('<div class="ge-wrapper ge-top" />').appendTo(B);
          (C = a('<div class="ge-addRowGroup btn-group" />').appendTo(b)),
            a.each(E.new_row_layouts, function (b, c) {
              var d = a(
                '<a class="btn-sm btn-grid btn-square btn-grid p-10" />'
              )
                .attr('title', 'Add row ' + c.join('-'))
                .on('click', function () {
                  var a = r().appendTo(A);
          ...
          var c = a(
              '<div class="dropdown float-start float-xl-end ge-layout-mode"><button type="button" class="btn-screen dropdown-toggle" data-toggle="dropdown"><span>Desktop</span></button><ul class="dropdown-menu" role="menu"><li><a data-width="auto" title="Desktop" class="dropdown-item"><span>Desktop</span></a></li><li><a title="Tablet" class="dropdown-item"><span>Tablet</span></li><li><a title="Phone" class="dropdown-item"><span>Phone</span></a></li></ul></div>'
            )
              .on('click', 'a', function () {
                var b = a(this);
              ...
              .appendTo(b),
            e = a('<div class="btn-group float-start float-xl-end"/>').appendTo(
              b
            ),
            h = a(
              '<button title="Edit Source Code" type="button" class="btn-code gm-edit-mode"><span class="fa fa-chevron-left"></span><span class="fa fa-chevron-right"></span></button>'
            )
              .on('click', function () {
                h.hasClass('active')
                  ? (A.empty().html(D.val()).show(), f(), D.hide())
                  : (g(),
                    D.height(0.8 * a(window).height())
                      .val(A.html())
                      .show(),
                    A.hide()),
                  h.toggleClass('active btn-danger');
              })
              .appendTo(e),
            i = a(
              '<button title="Preview" type="button" class="btn-code gm-preview m-r-5"><span class="fa fa-eye"></span></button>'
            )
              ...
              j(c, 'Move', 'ge-move', 'fa-arrows'),
                ...
                E.row_tools.forEach(function (a) {
                  j(
                    ...
                    a.title || '',
                    a.className || '',
                    a.iconClass || 'fa-wrench',
                    a.on
                  );
                }),
                j(c, 'Remove row', '', 'fa-trash', function () {
                  window.confirm('Delete row?') &&
                    b.slideUp(function () {
                      b.remove();
                    });
                }),
        ...
        function j(b, c, d, e, f) {
          ...
          'function' == typeof f && g.on('click', f),
            'object' == typeof f &&
        ...
        function k(b, c) {
          ...
          return (
            c.forEach(function (c) {
              var d = a('<a class="btn btn-sm btn-default" />')
                .html(c.label)
                .attr(
                  'title',
                  c.title ? c.title : 'Toggle "' + c.label + '" styling'
                )
                .toggleClass('active btn-primary', b.hasClass(c.cssClass))
                .on('click', function () {
                  d.toggleClass('active btn-primary'),
                    b.toggleClass(c.cssClass, d.hasClass('active'));
                })
                .appendTo(e);
            }),
            d
        ...
        function s(b) {
          return a('<div/>')
            ...
            .append(w().html(y(E.content_types[0]).initialContent));
        }

        function t(b) {
          E.custom_filter.length &&
            a.each(E.custom_filter, function (a, c) {
        ...
        function u() {
          A.find('.column').each(function () {
            ...
            b.children().each(function () {
              var b = a(this);
              b.is('.row, .ge-tools-drawer, .ge-content')
                ? v(c)
                : (c = c.add(b));
            }),
              v(c);
        ...
        function w() {
          return a('<div/>')
            .addClass('ge-content ge-content-type-' + E.content_types[0])
            .attr('data-ge-content-type', E.content_types[0]);
        }
        ...
        if (d.children().length && !d.find('div.row').length) {
          var J = d.children(),
            K = a('<div class="row"><div class="col-md-12"/></div>').appendTo(
              d
            );
      ...
      init: function (a, b) {
        ...
        b.each(function () {
          ...
          if (!b.hasClass('active')) {
            b.html() == c.initialContent && b.html('&nbsp;'),
              b.addClass('active').attr('contenteditable', 'true');
            var d = $.extend(
                {},
                a.ckeditor && a.ckeditor.config ? a.ckeditor.config : {},
                {
                  on: {
        ...
        b.each(function () {
          ...
          if (!b.hasClass('active')) {
            ...
            var d = $.extend(
              !0,
              {},
              a.summernote && a.summernote.config ? a.summernote.config : {},
              {
                tabsize: 2,
                airMode: !0,
                callbacks: {
      ...
      init: function (a, b) {
        ...
        b.each(function () {
          ...
          if (!b.hasClass('active')) {
            ...
            var d = $.extend(
              {},
              a.tinymce && a.tinymce.config ? a.tinymce.config : {},
              {
                inline: !0,
                oninit: function (b) {
                  $('#' + b.settings.id).focus();
