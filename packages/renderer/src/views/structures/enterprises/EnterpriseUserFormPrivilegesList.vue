  ...
  <div class="card mb-0">
    <div class="card-header pb-0">
      <div class="row align-items-center">
        ...
        <div
          v-if="$route.name === 'enterprise.form.iam.user.privileges'"
        ...
        >
          ...
          />
          <router-link
            :to="{ name: 'enterprise.form.iam.user.privileges.form' }"
...
<script>
import ActionLineSelectable from '/@/components/enterprise/ActionLineSelectable.vue';
