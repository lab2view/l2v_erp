...
xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    </a><img class="img-90 rounded-circle" src="../../../assets/images/dashboard/1.png" alt="">
...
class="fa fa-angle-right ps-2"
            ...
            <li class="dropdown"><a class="nav-link menu-title" href="../theme/index.html" target="_blank"><i
              data-feather="home"></i><span>Dashboard</span></a></li>
            <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
              data-feather="anchor"></i><span>Starter kit</span></a>
              <ul class="nav-submenu menu-content">
                <li><a class="submenu-title" href="javascript:void(0)">color version<span class="sub-arrow"><i
                ...
                <li><a class="submenu-title" href="javascript:void(0)">Page layout<span class="sub-arrow"><i
                  class="fa fa-chevron-right"></i></span></a>
                  <ul class="nav-sub-childmenu submenu-content">
                ...
                <li><a class="submenu-title" href="javascript:void(0)">Footers<span class="sub-arrow"><i
                  class="fa fa-chevron-right"></i></span></a>
                  <ul class="nav-sub-childmenu submenu-content">
            ...
            <li class="dropdown"><a
class="nav-link menu-title" href="http://support.pixelstrap.com/help-center"
                                    target="_blank"><i data-feather="headphones"></i><span>Raise Support</span></a></li>
            <li class="dropdown"><a
class="nav-link menu-title" href="https://docs.pixelstrap.com/viho/document/"
                                    target="_blank"><i
...
export default defineComponent({
  ...
  created() {
    ...
    setTimeout(() => this.INITIATE_MENU(), 1000);
  },
  methods: {
    INITIATE_MENU() {
